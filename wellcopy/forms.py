...
from wellcopy.models import Brand, Guitar
...
class CreateBrandForm(forms.ModelForm):
    ...
    class Meta:
        model = Brand
        fields = ['name', 'description', 'url', 'picture']  # Picture is manual
    ...
    def save(self, commit=True):
        instance = super(CreateBrandForm, self).save(commit=False)
...
class CreateGuitarForm(forms.ModelForm):
    ...
    class Meta:
        model = Guitar
        fields = ['name', 'specs', 'picture', 'brand']  # Picture is manual
    ...
    # Convert uploaded File object to a picture
    def save(self, commit=True):
        instance = super(CreateGuitarForm, self).save(commit=False)
